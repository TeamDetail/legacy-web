  ...
  return (
    <S.UserRecordArea>
      <S.ProgressBars>
        <ProgressBar
          title="탐험"
          value={myUserData!.data.record!.cardCount}
          max={226}
      ...
      <S.Records>
        기록
        <RecordItem title="탐험한 전체 블록 수" value={myUserData!.data.record!.allBlocks} unit="블록" />
        <RecordItem title="탐험한 유적지 블록 수" value={myUserData!.data.record!.ruinsBlocks} unit="블록" />
        <RecordItem title="수집한 모든 카드 수" value={myUserData!.data.record!.cardCount} unit="장" />
        <RecordItem title="수집한 찬란한 카드 수" value={myUserData!.data.record!.shiningCardCount} unit="장" />
